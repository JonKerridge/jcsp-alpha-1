 ...
 * extract a CNS server from the system property "jcsp.tcpip.DefaultCNSServer" with the server specified
...
public class TCPIPNodeFactory implements NodeFactory
{
   ...
   public TCPIPNodeFactory()
   {
      try
      {
         String svr = System.getProperty("jcsp.tcpip.DefaultCNSServer");
         if (svr == null)
         {
            try
            {
