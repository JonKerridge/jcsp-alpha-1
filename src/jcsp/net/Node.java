 ...
 * <code>jcsp.net.tcpip</code> package is provided but could easily
 ...
 * </p>
 * <p>
 * The <code>{@link jcsp.net.tcpip.TCPIPNodeFactory}</code> has
 ...
 * <code>{@link jcsp.net.tcpip.TCPIPNodeFactory}</code> for
...
public class Node
{
   ...
   private static NodeFactory factory = jcsp.net.tcpip.TCPIPNodeFactory.instantiate();
   ...
   throws IllegalStateException, IllegalArgumentException, NodeInitFailedException
   {
      ...
      if (initialized)
         throw new IllegalStateException("Attempted to initialize jcsp.net.Node twice!");
    ...
    * <code>{@link jcsp.net.tcpip.TCPIPNodeFactory}</code>.
   ...
   {
      if (!initialized)
         throw new IllegalStateException("jcsp.net.Node not initialized.");
   }
