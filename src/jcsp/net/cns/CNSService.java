 ...
 * (see <code>{@link ServiceManager}</code>).
...
public class CNSService implements Service, CNSUser
{
    ...
    */
   public static final String CNS_DEFAULT_SERVICE_NAME = "jcsp.net.cns.CNSService - The CNS.";
   ...
   public static CNSService install(NodeKey key, NodeAddressID cnsAddress, String serviceName)
   {
      ...
      if (sm.installService(cnsService, serviceName))
      {
         if (cnsService.init(null))
         {
            ...
            {
               Node.info.log("jcsp.net.cns.CNSService", "CNSService Started");
               return cnsService;
            }
         }
      ...
      {
         Node.info.log("jcsp.net.cns.CNSService", "CNSService failed to start");
