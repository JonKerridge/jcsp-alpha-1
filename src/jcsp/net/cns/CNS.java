 ...
 * <code>jcsp.net.Service</code> interface and can be installed
 * in the same way as any other other service by using the service manager
 * ({@link ServiceManager}). Alternatively, the
 ...
 * &lt;JCSP-CONFIG&gt;<br />
 *   &lt;PROTOCOLS&gt;<br />
 *     &lt;PROTOCOL id="TCPIP" name="TCP/IP" idclass="jcsp.net.tcpip.TCPIPProtocolID"&gt;<br />
 *     &lt;/PROTOCOL&gt;<br />
 *   &lt;/PROTOCOLS&gt;<br />
 *   &lt;ADDRESSES&gt;<br />
...
public class CNS implements Service, CSProcess
{
   ...
   public final static String CNS_DEFAULT_SERVICE_NAME = "jcsp.net.cns:Channel Name Server";
   
   /*---------------Package level constants-------------------------------------*/
   
   final static String CNS_CHANNEL_LABEL = "jcsp.net.cns.CNSLabel";
   ...
   /**
    * @see NamedChannelEndFactory#createNet2One(String)
    */
   ...
   /**
    * @see NamedChannelEndFactory#createNet2One(String, NameAccessLevel)
    */
   ...
   /**
    * @see NamedChannelEndFactory#createNet2Any(String)
    */
   ...
   /**
    * @see NamedChannelEndFactory#createNet2Any(String, NameAccessLevel)
    */
   ...
   /**
    * @see NamedChannelEndFactory#createOne2Net(String)
    */
   ...
   /**
    * @see NamedChannelEndFactory#createOne2Net(String, NameAccessLevel)
    */
   ...
   /**
    * @see NamedChannelEndFactory#createAny2Net(String)
    */
   ...
   /**
    * @see NamedChannelEndFactory#createAny2Net(String, NameAccessLevel)
    */
   ...
   public static CNS install(NodeKey key, String serviceName)
   {
      ...
      if (sm.installService(cns, serviceName))
      {
         ...
         {
            Node.info.log("jcsp.net.cns.CNS", "CNS Started");
            return cns;
         }
         else
         {
      ...
      {
         Node.info.log("jcsp.net.cns.CNS", "CNS failed to start");
